...
class SellerProfile(models.Model):
    ...
    identity_document = models.FileField(upload_to='seller_docs/', blank=True, verbose_name=_('Pièce d\'identité'))
    rccm_document = models.FileField(upload_to='seller_docs/', blank=True, verbose_name=_('RCCM'))
...
class DeliveryProfile(models.Model):
    ...
    license_document = models.FileField(upload_to='delivery_docs/', blank=True, verbose_name=_('Permis de conduire'))
    ...
    def can_deliver(self):
        return self.verification_status == 'approved' and self.is_available
